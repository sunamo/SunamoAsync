...
Lightweight helper for running async methods synchronously in .NET using a custom `SynchronizationContext` to safely block on async code without deadlocks.
